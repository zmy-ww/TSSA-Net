...
root_folder = r'E:\Technolgy_learning\Learning_code\AD\ATPGCN-main\ATPGCN-ABIDE\getabide\ABIDE-871'
...
# Get the list of subject IDs  得到所有id
def get_ids(num_subjects=None):
    ...
    # subject_IDs = np.genfromtxt(os.path.join(data_folder[:-14], 'subject_IDs.txt'), dtype=str)
    subject_IDs = []
    file_path = (r'E:\Technolgy_learning\Learning_code\AD\ATPGCN-main\ATPGCN-ABIDE\getabide\ABIDE-871\ABIDE_pcp\cpac'
                 r'\filt_noglobal')
...
def create_affinity_graph_from_scores(scores, subject_list):
    ...
    for l in scores:
        ...
        # quantitative phenotypic scores l并不在这两个当中
